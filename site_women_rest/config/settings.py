...
SECRET_KEY = "django-insecure-7e@vjaos+!58i)7vn#00ieu4hg@=%^m1e++_kmlxt!!e4gkihj"
...
INSTALLED_APPS = [
    ...
    # подключение Django REST , перед етим установили через  pip install djangorestframework
    "rest_framework",
]
